...
import { FaCamera } from "react-icons/fa"; // Import scan icon
...
export default function DashboardPage() {
  ...
  const fileInputRef = useRef(null); // Ref for hidden input (camera)
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const analysisResponse = await axios.post(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/analyze-food`, {
        userId: user._id,
  ...
  // Function to trigger the hidden file input (opens camera on mobile)
