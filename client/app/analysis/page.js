...
export default function AnalysisPage() {
  ...
  // Once analysisResult is set, scroll to the top of the FoodAnalysis component.
  useEffect(() => {
    if (analysisResult && analysisRef.current) {
      // Adjust navbarHeight if your fixed navbar overlaps content
      const navbarHeight = 80; // Change this value as needed
  ...
  const handleSubmit = async (e) => {
    ...
    // Hide the upload area and show the loader immediately
    setLoading(true);
